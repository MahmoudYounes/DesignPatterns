...
{
    public class OnePlus : IAbstractMobile
    {
        ...
        public OnePlus(string type)
        {
            MobileType = type;
        }
        public OnePlus(string type, string ram, string processor, string camera, string internalStorage)
        {
            RAM = ram;
            Processor = processor;
            Camera = camera;
